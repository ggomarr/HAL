...
reg_main      = [ [ 'go to sleep|goodbye|all for now|you later',
                  ...
                  [ '(tell|gather|find|know|retrieve|search|look|get)(.*)?(about|on|for)? (.*)( on| in| from) wikipedia',
                    actions.wiki_action, 3 ],
                  [ '(tell|gather|find|know|retrieve|search|look|get)(.*)?(about|on|for) (.*)',
                    actions.wiki_action, 3 ], 
